                ...
                <div class="cadre">
                    ...
                    <div class="bloc">
                        ...
                        <div class="bloc-profil">
                            <div class="avatar">
                                <div class="profil" style="background-image:$_SESSION['admin']['avatar']"></div>
                                <div class="user"><h1 id="user">Mamadou</br>Sylla <?php //echo $_SESSION['admin']['prenom']."</br> ". $_SESSION['admin']['nom']?><h1></div>  
                        ...
                        <div class="bloc-item">
                            <?php
                        if(!isset($_GET['page'])) {
                            $page='administrateur.php?page=liste_question';
                        } else {
                            $page=$_GET['page'];
                            switch($page) {
                                case'liste_question':
                                ...
                                case'creer_question':
                                        ...
                                        break;
                                case'default':
                                        include('administrateur.php?page=liste_question');
                                        break;
                                    }
                                }
                            ?>
